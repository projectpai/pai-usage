// spend.go - Spending P2SH multisig funds to a Paicoin address.
package multisig
...
// generateSpend is the high-level logic for spending from a P2SH multisig address with the 'go-paicoin-multisig spend' subcommand.
